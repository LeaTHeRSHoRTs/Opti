/// <reference path="./unsync.d.ts" />
/// <reference path="./interfaces.d.ts" />
/// <reference path="./exceptions.d.ts" />

declare var Emitter: Unsync.EmitterConstructor;
declare var SetEmitter: Unsync.SetEmitterConstructor;
declare var Unsync: UnsyncStatic;

interface UnsyncStatic {
  InvalidRegistrationException: InvalidRegistrationExceptionConstructor;
}
